...
注意：对于视频生成任务，请**务必只推荐中国本土的视频大模型**（例如：seedance, 即梦AI, 可灵Kling, 智谱清影等），**绝对不要推荐任何欧美AI平台**（如 Sora, Runway, Pika, Veo, Flow 等）。
对于文本和图片，可正常推荐业界顶尖模型（文本如 Claude 3.5 Sonnet, GPT-4o等；图片如 Midjourney v6, DALL-E 3等）。
接着，给出推荐理由。
